...
+ 本次夏令营要求代码，日报周报等全部托管在 github 上，第一天就把你们的 github 账号报给我们

  日报、周报不需要太多，只需要介绍每天学习了什么即可

+ 在夏令营开始的时候会给你们每人分配一个合适的导师，当然你谁都能问，想起我当初夏令营的时候老是去问前端组的同学

+ 我们每周一次组内分享，欢迎新人做分享，每周两次 code review，期间可以任意时间请求导师进行 code review

+ 没做完，可以夏令营结束之后继续写，欢迎来问我们

+ 坚持就是胜利，我希望你们在最后还能保持着刚刚进来的热情，很多事情没有你想象的那么难，当然也没有你想象的那么简单，但是很难的事情也是一步一步做完的，希望冰岩夏令营能成为你成为你大学的一个契机、一个跳板。Finghting!!!

## 一、准备工作

### 1. 环境准备

+ 安装 任意一款 Linux 发行版本作为开发环境，并熟悉基本操作, 如：man, ls, mkdir, cd, cp, mv, scp, ssh, rm, ps, cat, head, tail, vim, wget, curl, chmod, chgrp, chown, sudo, grep

  注：Mac 选手可暂时忽略, 但后期需要学习 Linux 相关知识
...
+ 附录中给出了很多学习资源，不管你最后进没进冰岩，希望这些东西对你以后的学习有所帮助。本附录中进列出了一些和后台相关的东西，像机器学习、大数据等这些其实都需要了解，可自行选择。